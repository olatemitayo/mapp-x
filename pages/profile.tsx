...
import { BackgroundImage, Box, Center, Menu } from "@mantine/core";
  ...
  return (
    <>
      <main className="grid grid-cols-[auto_1fr]">
        <Sidebar />
        <div className="py-6 flex-1 px-5  bg-[#F5F5F6] overflow-x-auto ">
          ...
          <div>
            <div className="flex justify-between  bg-white rounded-b-lg px-10 items-center ">
          ...
          <div className="mt-5 flex  justify-between text-[14px]">
            ...
            <div className="bg-white w-[32%] flex flex-col  rounded-xl">
              ...
              {/* ABOUT CONTENT  */}
              <div className="flex flex-col gap-8 px-7 py-5">
                <div className="flex gap-3 items-center">
                  <span>
                    <Image width={16} height={16} alt="des" src={"/des.svg"} />
                  </span>
                  <p className="#4A4C58">
                    Designation:
              ...
              <div className="flex flex-col gap-6 px-7  ">
                ...
                <div className="flex gap-3 items-center justify-between">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h5 className="text-16 font-semibold">Musa Abdulahi</h5>
