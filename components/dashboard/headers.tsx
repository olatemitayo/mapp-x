        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col gap-[2px]">
            ...
            <p className="text-[#C1C2C6] text-[14px]">
              <span className="text-[#30AD74]">{HeaderItems[1].change}</span>{" "}
              {HeaderItems[1].when}
            </p>
          </div>
        </div>
              ...
              <div className="flex flex-col gap-3">
                <Link href="#">
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <Image src="/Kenya.svg" alt="flag" width={50} height={50} />
                  </div>
                </Link>
                <Link href="#">
                  <div className="flex items-center justify-between gap-1">
                ...
                <Link href="#">
                  <div className="flex items-center justify-between gap-1">
                    ...
                    <Image src="/usa.svg" alt="flag" width={50} height={50} />
                  </div>
                </Link>
              </div>
            </Popover.Dropdown>
...
function FEOHeader() {
  const [fheader, setFHeader] = useState<any>([]);
  //get dashboard data
  //to get data for the country
  const feoFetch = async () => {
    const token = JSON.parse(localStorage.getItem("my-user"))?.access;
    try {
      const res = await fetch(
        "https://mapx.onrender.com/api/admin/dashboard/",
        ...
        <div className="flex  min-w-[280px] min-h-[100px] items-center w-[16%]  rounded-2xl gap-3 justify-start ps-4 bg-white">
          <div className="flex items-center gap-5">
            ...
            <div className="flex flex-col gap-[2px]">
              ...
              <h2 className="text-2xl font-[600] text-[#252735]">
                {fheader.mapped_farmlands_count}
              </h2>
              <p className="text-[#C1C2C6] text-[14px]">
        ...
        <div className="flex  min-w-[280px] min-h-[100px] items-center w-[16%]  rounded-2xl gap-3 justify-start ps-4 bg-white">
          <div className="flex gap-5 ">
            ...
            <div className="flex flex-col gap-[2px]">
              ...
              <h2 className="text-2xl font-[600] text-[#252735]">
                {fheader.unmapped_farmlands_count}
              </h2>
            </div>
          </div>
        </div>
